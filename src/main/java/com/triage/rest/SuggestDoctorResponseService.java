...
import com.triage.logic.response_producer.ResponseProducerSuggestDoctor;
...
@Path("/symptomCheckerResponse")
public class SuggestDoctorResponseService {
	 ...
	 */
	public Response suggestDoctor(@FormParam("chatid") String chatId,						
		...
		System.out.println("Calling suggest doctor response...");
		ResponseProducerSuggestDoctor rp = new ResponseProducerSuggestDoctor(restRequest, user, lastq);
