...
import com.triage.logic.response_producer.ResponseProducerTherapy;
...
@Path("/therapyResponse")
public class TherapyResponseService {
	@POST
	 ...
	 */
	public Response therapy(@FormParam("chatid") String chatId,						
		...
		System.out.println("Calling therapy response...");
		ResponseProducerTherapy rp = new ResponseProducerTherapy(restRequest, user, lastq);
