...
import com.triage.logic.response_producer.ResponseProducerMedicalDictionary;
...
@Path("/medicalDictionaryResponse")
public class MedicalDictionaryResponseService {
	@POST
	 ...
	 */
	public Response dictionary(@FormParam("chatid") String chatId,						
		...
		System.out.println("Calling medical dictionary response...");
		ResponseProducerMedicalDictionary rp = new ResponseProducerMedicalDictionary(restRequest, user, lastq);
